...
# python3 src/githubClient/v4/main.py
...
def fetch_paginated(query_template, root_field, sub_field=None, limit=5000000):
    """
...
print("✅ Dados do repositório JabRef/jabref salvos em jabref_github_data.json (até 5000000 registros por categoria)")
